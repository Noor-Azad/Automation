...
public sealed class CustomerProviderProfileTests : AuthenticatedCustomerBaseTest, IClassFixture<PlaywrightFixture>
{
    public CustomerProviderProfileTests(PlaywrightFixture fixture, ITestOutputHelper output)
        : base(fixture, output) { }
