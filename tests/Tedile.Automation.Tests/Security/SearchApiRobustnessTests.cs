...
public sealed class SearchApiRobustnessTests : BaseTest, IClassFixture<PlaywrightFixture>
{
    ...
    [Fact]
    public async Task Provider_search_handles_sql_like_keyword_as_plain_input()
    {
    ...
    [Fact]
    public async Task Provider_search_handles_xss_like_keyword_without_server_error()
    {
